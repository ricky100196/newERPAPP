    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="#">Supplyer</a></div>
        ...
        <div class="section-body">
            ...
            <p class="section-lead">Masukkan data supplyer.</p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal" id="form-simpan" role="form" method="post" action="<?= site_url('supplyer/save/'.@$id) ?>" style="margin:20px;">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        <label for="customer_name">Nama</label>
                                        <input type="text" class="form-control" value="<?php echo isset($data->supplier_name) ? $data->supplier_name : '' ?>" name="nama" id="nama" placeholder="Masukan Nama Supplyer" required>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-md-12">
                                        <label for="delivery_address">Alamat Supplier</label>
