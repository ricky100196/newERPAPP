    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <div class="toolbar">
                    <button type="button" data-toggle="modal" data-target="#modal-popout" onclick="tambah()" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Responden</button>
                </div>
                <hr>
                        ...
                        <tbody>
                            ...
                            foreach ($data as $row) : ?>
                                <tr>
                                    ...
                                    <td><?= $row->no_hp ?></td>
                                    <td>
                                        <a target="_blank" href="<?= base_url('form?code=' . $row->code) ?>"><?= base_url('form?code=' . $row->code) ?></a>
                                    </td>
