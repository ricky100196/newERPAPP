                            ...
                            <form id="form-simpan" method="POST" action="<?= site_url('admin/surat_jalan/save') ?>">
                                <div class="form-group col-md-12"> 
                                    ...
                                    <select name="data_frp_id" id="data_frp_id" class="form-control" required> 
                                        ...
                                        ?>
                                        <option value="<?= $item->id ?>" <?= set_value('no_pol') == $item->id ? 'selected' : '' ?>><?= $item->po_no ?></option> 
                                        <?php
                                        endforeach;
                                        ?>
                                    </select> 
                                ...
                                <div class="form-group col-md-12"> 
                                    ...
                                    <input type="text" name="no_pol" class="form-control" value="<?= set_value('no_pol'); ?>" required>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                                ...
                                                <input type="date" name="exit_date" class="form-control" value="<?= set_value('exit_date'); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group"> 
                                                <label for="data_frp_id">QTY</label> 
                                                <input type="number" name="qty" class="form-control" value="<?= set_value('qty'); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12"> 
                                    ...
                                    <textarea name="information" class="form-control" rows="4" required><?= set_value('information'); ?></textarea>
                                </div>
