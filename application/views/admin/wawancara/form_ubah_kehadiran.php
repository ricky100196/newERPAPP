<form method="POST" autocomplete="off" action="<?= base_url('wawancara/ubah_wawancara_kehadiran') ?>">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-12 selectku mb-2">
                ...
                <select class="form-control js-select2" required="" id="status" name="status">
                    ...
                    <option value="guru" <?php echo @$data_row->guru == 'guru' ? ' selected' : '' ?>>Guru</option>
                </select>
            </div>
        </div>
    </div>
