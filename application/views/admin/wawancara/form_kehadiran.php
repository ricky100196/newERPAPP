...
<script>
function save_kehadiran(id, nama_peserta, nama_sekolah, status) {
    ...
    if (message) {
        window.location.href = ("<?= base_url('wawancara/simpan_wawancara_kehadiran'); ?>") + "/" + id + "/" +
            nama_peserta + "/" + nama_sekolah + "/" + status
    } else return false
