                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="text-sm-right">
                            <a href="<?= site_url('admin/coach/index') ?>" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
                </div>
                <?php if (!@$id) { ?>
                    <form class="form-horizontal" id="form-simpan" role="form" method="post" action="<?= site_url('admin/coach/simpan') ?>" style="margin:20px;">
                    <?php } else { ?>
                        <form class="form-horizontal" id="form-simpan" role="form" method="post" action="<?php echo base_url('admin/coach/update') ?>" style="margin:20px;">
                        <?php } ?>
                        <div class="container">
                            <div class="row">
                                <div class="form-group col-md-6 col-md-6">
                                    <label for="jabatan">NIP</label>
                                    <input type="text" class="form-control" name="nip" id="nip" placeholder="Masukan NIP" value="<?php echo isset($data->nip) ? $data->nip : '' ?>">
                                </div>
                                <div class="form-group col-md-6 col-md-6">
                                    <label for="jabatan">NUPTK</label>
                                    <input type="text" class="form-control" name="nuptk" id="nuptk" placeholder="Masukan NUPTK" onchange="validasi_identitas()" value="<?php echo isset($data->nuptk) ? $data->nuptk : '' ?>">
                                </div>
                                <div class="form-group col-md-6 col-md-6">
