            ...
            <div class="card-body">
                ...
                <div class="toolbar">
                    <button type="button" data-toggle="modal" data-target="#modal-popout" onclick="tambah()"
                        class="btn btn-success"><i class="fa fa-plus"></i> Tambah Instrumen</button>
                </div>
                <?php } ?>
                <hr>
                    ...
                    <table id="datatable-buttons" class="table table-bordered nowrap"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->nama ?></td>
                                <td><?= (@$row->tanggal_monev?$row->tanggal_monev:'<span class="text-danger">Belum Monitoring</span>') ?></td>
                                <td><?= $row->tempat_monev ?></td>
                                <td><?= $row->nama_kab ?></td>
                                <td><?= $row->nama_prov ?></td>
                                <td>
                                    <a target="_blank" href="<?= base_url('form_observasi?id=' . encode_id($row->id)) ?>" class="btn btn-sm btn-outline-danger">Isi hasil observasi</a>
                                    <a target="_blank" href="<?= base_url('form_observasi/rekap/' . encode_id($row->id)) ?>" class="btn btn-sm btn-outline-info">Cetak</a>
                                </td>
