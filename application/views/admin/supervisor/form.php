                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <div class="text-sm-right">
                            <a href="<?= site_url('admin/supervisor/index') ?>" class="btn btn-danger">Kembali</a>
                        </div>
                    </div>
                </div>
                <?php if (!@$id) { ?>
                    <form class="form-horizontal" id="form-simpan" role="form" method="post" action="<?= site_url('admin/supervisor/simpan') ?>" style="margin:20px;">
                    <?php } else { ?>
                        <form class="form-horizontal" id="form-simpan" role="form" method="post" action="<?php echo base_url('admin/supervisor/update') ?>" style="margin:20px;">
                        <?php } ?>
                        <div class="container">
                            <div class="row">
