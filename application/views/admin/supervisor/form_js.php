<script>
    $(document).ready(function() {
        $('#provinsi').change(function() {
            ...
            console.log(id);
            $.ajax({
                url: "<?php echo base_url('admin/supervisor/get_kota'); ?>",
                method: "POST",
                data: {
                    id: id
                },
    ...
    $('#form-simpan').on('submit', function(e) {
        ...
        $.ajax({
            ...
            success: (res) => {
                ...
                location.replace("https://ministry.phicos.co.id/coaching_bbgp/admin/supervisor/index");
...
<script>
    ...
    function validasi_identitas() {
        ...
        $.ajax({
            type: "POST",
            url: '<?= base_url('admin/supervisor/cek_nip') ?>',
            data: {nip: nip},
            dataType: 'json',
        }).then((response)=>{
