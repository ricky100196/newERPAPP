                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Nama</label>
                            <input type="text" disabled class="form-control" value="<?= @$supervisor->nama ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Instansi</label>
                            <input type="text" disabled class="form-control" value="<?= @$supervisor->instansi ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Kabupaten</label>
                            <input name="" id="" disabled class="form-control" value="<?= @$supervisor->nama_kab ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Provinsi</label>
                            <input name="" id="" disabled class="form-control" value="<?= @$supervisor->nama_prov ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>No HP</label>
                            <input type="text" disabled class="form-control" value="<?= @$supervisor->no_hp ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Email</label>
                            <input type="text" disabled class="form-control" value="<?= @$supervisor->email ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
