...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">Daftar seluruh Material.</p>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="pull-right col-md-12">
                                    <a class="btn btn-rounded btn-sm btn-primary float-right" href="<?= base_url('MaterialUse/add') ?>"><i class="fa fa-plus mr-1"></i> Tambah Data</a>
                                </div>
                            </div>
                            <br>
                            <hr>
