...
class M_product_table extends CI_Model {
    var $table = 'data_product a'; //nama tabel dari database
    ...
    private function _get_datatables_query() {
        $this->db->select('a.*, customer_name');
        $this->db->from($this->table);
        $this->db->join('data_customer b', 'a.customer_id=b.id');
